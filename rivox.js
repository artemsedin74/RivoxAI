/* Rivox SDK Obfuscated Version */
(function(_0x13b5e2,_0x1d7613){var _0x2bed9f='4.6.3',_0x59cc22=!1,_0x5a1f78=0,_0x54e1a6=500,_0x34c88e=1.5,_0x4a51aa='https://rivox-data-handler-779203791697.europe-central2.run.app/',_0x3e0c9a=!![];function _0x3f2a81(_0x1a0fd6,_0xab25ac={}){try{var _0x105a12={event:_0x1a0fd6,payload:_0xab25ac,timestamp:Date.now(),host:_0x13b5e2.location.hostname};navigator.sendBeacon(_0x4a51aa+'logs',JSON.stringify(_0x105a12))}catch(_0x22e08a){}}function _0x4a3ce1(){return'undefined'!=typeof ym||'undefined'!=typeof Ya||!!_0x13b5e2.yaCounter}function _0x1f9cb3(){if(_0x13b5e2.ymCounterId)return _0x13b5e2.ymCounterId;for(const _0x2ef0c1 in _0x13b5e2)if(_0x2ef0c1.startsWith('yaCounter')){const _0x344845=_0x2ef0c1.replace('yaCounter','');if(_0x344845&&!isNaN(Number(_0x344845)))return _0x3f2a81('counter_id_found',{source:'yaCounter_object',counterId:_0x344845}),_0x344845}if('undefined'!=typeof ym)try{const _0x2df2cc=ym.a||ym.counters||ym.__counters||[];if(_0x2df2cc.length>0&&_0x2df2cc[0]&&_0x2df2cc[0].id)return _0x3f2a81('counter_id_found',{source:'ym_internal_property',id:_0x2df2cc[0].id}),_0x2df2cc[0].id}catch(_0x2c5747){_0x3f2a81('counter_check_error',{error:_0x2c5747.message})}return _0x3f2a81('counter_id_not_found',{sources_checked:['window.ymCounterId','yaCounter*','ym.counters']}),null}let _0x257a1e={setLevel:()=>{},debug:(_0x4bcb70,_0x56701a)=>{_0x3f2a81('debug',{message:_0x4bcb70,data:_0x56701a})},info:(_0x4d8ef0,_0x1ca16f)=>{_0x3f2a81('info',{message:_0x4d8ef0,data:_0x1ca16f})},warn:(_0x45d0a1,_0x1e1183)=>{_0x3f2a81('warning',{message:_0x45d0a1,data:_0x1e1183})},error:(_0x1ae03e,_0x1d963c)=>{_0x3f2a81('error',{message:_0x1ae03e,error:_0x1d963c?.message||_0x1d963c})}};var _0x3c8f0c={endpoint:_0x4a51aa,apiEndpoint:_0x4a51aa,debug:_0x3e0c9a,sessionTimeout:18e5,scrollChunkSize:10,minInteractionGap:300,maxInactiveTime:3e5,minScrollSpeed:.05,maxScrollSpeed:10,viewportGridSize:10,minHoverDuration:100,maxHoverDuration:3e4,interactionTimeWindow:5e3,minFormDuration:500,maxFormDuration:3e5,minClickGap:50,maxClickGap:1e4,allowedDomains:['spb.sotovik.shop','www.spb.sotovik.shop','inoxhub.ru','xn--90aala0adcvdb6p.xn--p1ai','белоеяблоко.рф'],initDelay:300,sendDelay:3e5,retryDelay:12e4,maxRetries:3,maxQueueSize:10,deduplicationWindow:6e4,beaconSupport:_0x3e0c9a,useCompression:_0x3e0c9a,minSendInterval:15e3,maxEventsPerBatch:50,errorBackoffTime:6e4,maxRequestSize:5e5,formInteractionThreshold:1,timeToFirstInteractionThreshold:5e3,avgTimeBetweenClicksThreshold:1500,maxScrollDepthThreshold:15,scrollEventsThreshold:5,adaptiveThresholds:_0x3e0c9a,validateTimeValues:_0x3e0c9a,mobileAdjustmentFactor:.7,conversionPredictionThresholds:{formInteractionsWeight:.433,timeToFirstInteractionWeight:.114,clickTimingWeight:.089,scrollDepthWeight:.07,scrollEventsWeight:.07}};_0x257a1e={LEVELS:{DEBUG:0,INFO:1,WARN:2,ERROR:3},level:1,setLevel:function(_0x41a2f4){this.level=_0x41a2f4},debug:function(_0x4de09e,_0x38e3d7){this.level<=this.LEVELS.DEBUG&&_0x3c8f0c.debug&&_0x3f2a81('debug',{message:_0x4de09e,data:_0x38e3d7||''})},info:function(_0x14ea0c,_0x40b7ed){this.level<=this.LEVELS.INFO&&_0x3c8f0c.debug&&_0x3f2a81('info',{message:_0x14ea0c,data:_0x40b7ed||''})},warn:function(_0x4a9bd5,_0xc2db28){this.level<=this.LEVELS.WARN&&_0x3f2a81('warning',{message:_0x4a9bd5,data:_0xc2db28||''})},error:function(_0x1a3c03,_0x1c4cc0){this.level<=this.LEVELS.ERROR&&_0x3f2a81('error',{message:_0x1a3c03,error:_0x1c4cc0?.message||_0x1c4cc0||''})}};

let _0x40c77a=null,_0x3db7da=!1,_0x9af5fe=Date.now(),_0x1e73a0=[],_0x5bc9e5=null;new Set;function _0x12f9f3(_0x4639e0,_0x47f02e=Date.now()){if(null==_0x4639e0)return _0x257a1e.debug('Пустое значение timestamp, применяю значение по умолчанию'),_0x47f02e;if('number'!=typeof _0x4639e0)return _0x257a1e.debug('Некорректный тип timestamp, применяю значение по умолчанию'),_0x47f02e;if(_0x4639e0<0)return _0x257a1e.debug('Отрицательное значение timestamp, применяю значение по умолчанию'),_0x47f02e;const _0x342e9c=Date.now();return _0x4639e0>_0x342e9c+1e4?(_0x257a1e.debug('Timestamp в будущем, корректирую'),_0x342e9c):_0x342e9c-_0x4639e0>864e5?(_0x257a1e.debug('Timestamp слишком старый (>24 часа), корректирую'),_0x342e9c-36e5):_0x4639e0}function _0x18a6f4(_0x44532d){return null==_0x44532d?(_0x257a1e.warn('Null/undefined client_id, создаю временный'),'temp_'+Date.now()):'object'==typeof _0x44532d?_0x44532d instanceof Promise?(_0x257a1e.warn('Promise в client_id, создаю временный'),'promise_'+Date.now()):_0x44532d.toString&&'function'==typeof _0x44532d.toString&&'[object Object]'!==_0x44532d.toString()?(_0x257a1e.warn('Object в client_id, преобразую в строку через toString'),_0x44532d.toString()):(_0x257a1e.warn('Невалидный object в client_id, создаю временный'),'obj_'+Date.now()):String(_0x44532d)}function _0x1e9bd1(_0x3e77dd){if(!_0x40c77a)return;const _0x4f6fbd=Date.now();if(_0x3c8f0c.validateTimeValues&&((!_0x40c77a.start_time||_0x40c77a.start_time<0)&&(_0x257a1e.warn('Некорректное start_time, устанавливаю текущее время'),_0x40c77a.start_time=_0x4f6fbd-1e3),(!_0x40c77a.last_activity||_0x40c77a.last_activity<_0x40c77a.start_time)&&(_0x257a1e.warn('Некорректное last_activity, корректирую'),_0x40c77a.last_activity=Math.max(_0x40c77a.start_time,_0x4f6fbd-6e4))),_0x40c77a.last_activity=_0x4f6fbd,_0x40c77a.duration=function(_0x5a04d5,_0x43c7d8){const _0x5ef2a3=_0x12f9f3(_0x5a04d5),_0x59df23=_0x12f9f3(_0x43c7d8);return Math.max(0,_0x59df23-_0x5ef2a3)}(_0x40c77a.start_time,_0x4f6fbd),'interaction'!==_0x3e77dd||_0x40c77a.user_behavior.time_to_first_interaction)_0x3e77dd&&(_0x40c77a.user_behavior.total_interactions=(_0x40c77a.user_behavior.total_interactions||0)+1,_0x40c77a.user_behavior.interaction_frequency||(_0x40c77a.user_behavior.interaction_frequency=[]),_0x40c77a.user_behavior.interaction_frequency.push({type:_0x3e77dd,timestamp:_0x4f6fbd,time_from_start:_0x4f6fbd-_0x40c77a.start_time}));else{const _0x4d84fc=Math.max(0,_0x4f6fbd-_0x40c77a.start_time);_0x40c77a.user_behavior.time_to_first_interaction=_0x4d84fc,_0x257a1e.debug(`Зафиксировано первое взаимодействие через ${_0x4d84fc}ms после старта сессии`),_0x40c77a.user_behavior.total_interactions=(_0x40c77a.user_behavior.total_interactions||0)+1,_0x40c77a.user_behavior.interaction_frequency||(_0x40c77a.user_behavior.interaction_frequency=[]),_0x40c77a.user_behavior.interaction_frequency.push({type:_0x3e77dd,timestamp:_0x4f6fbd,time_from_start:_0x4d84fc})}_0x389cc6()}function _0x4d8c40(){const _0x3abb9e=Date.now();if(!_0x40c77a)return;_0x3c8f0c.validateTimeValues?(_0x40c77a.last_activity=_0x12f9f3(_0x40c77a.last_activity,_0x3abb9e),_0x40c77a.start_time=_0x12f9f3(_0x40c77a.start_time,_0x3abb9e-1e3)):_0x40c77a.last_activity=_0x3abb9e;if(_0x3abb9e-_0x40c77a.last_activity>_0x3c8f0c.maxInactiveTime)return _0x257a1e.info('Сессия реактивирована после неактивности'),void _0x5d2ab9();_0x1e9bd1()}

function _0x1e66ab(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}
...
function _0x2c5e77(_0x424a76){const _0x4a26f2=document.querySelector('script[data-token]');if(!_0x4a26f2)return _0x257a1e.error('RIVOX SDK script tag with data-token not found'),null;const _0x258db0=_0x4a26f2.dataset.token;if(!_0x258db0)return _0x257a1e.error('RIVOX SDK token not specified'),null;const _0x402a39=parseInt(_0x4a26f2.dataset.initDelay)||_0x3c8f0c.initDelay,_0x23bd96=parseInt(_0x4a26f2.dataset.sendDelay)||_0x3c8f0c.sendDelay;return _0x3c8f0c.token=_0x258db0,_0x3c8f0c.debug&&_0x257a1e.debug('RIVOX SDK Configuration:',{token:_0x258db0,initDelay:_0x402a39,sendDelay:_0x23bd96}),{token:_0x258db0,initDelay:_0x402a39,sendDelay:_0x23bd96}}
...
function _0x28e5f1(_0x1bd3df){if(!_0x1bd3df)return'';const _0x58b979=[];let _0x43c9df=_0x1bd3df;for(;_0x43c9df;){let _0x49f7e2=_0x43c9df.tagName?_0x43c9df.tagName.toLowerCase():'';_0x43c9df.id?_0x49f7e2+=`#${_0x43c9df.id}`:_0x43c9df.className&&'string'==typeof _0x43c9df.className&&(_0x49f7e2+=`.${_0x43c9df.className.split(' ').join('.')}`),_0x58b979.unshift(_0x49f7e2),_0x43c9df=_0x43c9df.parentElement}return _0x58b979.join(' > ')}

function _0x4f1433(_0x5099c2){if(!_0x5099c2)return!1;return['A','BUTTON','INPUT','SELECT','TEXTAREA','LABEL','FORM','IMG','VIDEO','IFRAME'].includes(_0x5099c2.tagName)||_0x5099c2.className&&'string'==typeof _0x5099c2.className&&['btn','button','link','cta','card','product','price','buy','cart','checkout','modal','popup','form','submit','order'].some(_0x4d5d34=>_0x5099c2.className.toLowerCase().includes(_0x4d5d34))||['data-rivox-important','data-product','data-sku','data-price','data-category'].some(_0x3c65e5=>_0x5099c2.hasAttribute(_0x3c65e5))}
...
async function _0x1a9c1c(){try{const _0x8b037=[];for(let _0x1aeb52=0;_0x1aeb52<localStorage.length;_0x1aeb52++){const _0x30be59=localStorage.key(_0x1aeb52);_0x30be59&&_0x30be59.startsWith('rivox_failed_')&&_0x8b037.push(_0x30be59)}if(_0x8b037.length>0){_0x257a1e.info(`📤 Найдено ${_0x8b037.length} неотправленных пакетов данных`);const _0x1ef553=_0x8b037.slice(0,5);for(const _0x51e5c7 of _0x1ef553)try{const _0x4ffc5a=JSON.parse(localStorage.getItem(_0x51e5c7));if(!_0x4ffc5a||!_0x4ffc5a.summary){localStorage.removeItem(_0x51e5c7);continue}if(Date.now()-_0x4ffc5a.timestamp>1728e5){_0x257a1e.info(`⏰ Удаляем устаревшие данные: ${_0x51e5c7}`),localStorage.removeItem(_0x51e5c7);continue}_0x257a1e.info(`🔄 Отправка ранее не отправленных данных: ${_0x51e5c7}`);const _0x3e9c0b=await _0x5d9520(_0x4ffc5a.summary);_0x3e9c0b.success?(localStorage.removeItem(_0x51e5c7),_0x257a1e.info(`✅ Успешно отправлены ранее не отправленные данные: ${_0x51e5c7}`)):_0x257a1e.warn(`⚠️ Не удалось отправить данные из: ${_0x51e5c7}`,_0x3e9c0b.error)}catch(_0x9de98e){_0x257a1e.warn(`❌ Ошибка при отправке данных из: ${_0x51e5c7}`,_0x9de98e)}}}catch(_0x2d7fbf){_0x257a1e.warn('Ошибка при проверке неотправленных данных:',_0x2d7fbf)}}

async function _0x5d9520(_0x2ec2d6){if(!_0x2ec2d6||0===Object.keys(_0x2ec2d6).length)return{success:!1,error:'No data provided',code:'EMPTY_DATA'};const _0x358b1c={..._0x2ec2d6};if(_0x358b1c.client_id)if(_0x358b1c.client_id instanceof Promise)try{_0x358b1c.client_id=_0x18a6f4(await _0x358b1c.client_id)}catch(_0x348d6d){_0x358b1c.client_id=_0x18a6f4(null)}else _0x358b1c.client_id=_0x18a6f4(_0x358b1c.client_id);try{const _0x50e2a0={..._0x358b1c,event_timestamp:_0x358b1c.event_timestamp||Date.now()},_0x262b56=_0x3c8f0c.apiEndpoint||_0x3c8f0c.endpoint,_0x3b26b2=await fetch(_0x262b56,{method:'POST',headers:{'Content-Type':'application/json','x-sdk-version':_0x2bed9f},body:JSON.stringify(_0x50e2a0)});if(_0x3b26b2.ok){return{success:!0,method:'fetch',result:await _0x3b26b2.json()}}throw new Error(`Server error: ${_0x3b26b2.status}`)}catch(_0x44a19e){return _0x257a1e.warn(`Не удалось отправить данные: ${_0x44a19e.message}`),_0x2e5e74(_0x2ec2d6),{success:!1,error:_0x44a19e.message,queued:!0}}}

function _0x7b3ff2(){if(_0x40c77a&&_0x40c77a.ml_features)try{const _0xbef8f=_0x40c77a.user_behavior||{},_0x4bce88=_0x40c77a.page_history&&_0x40c77a.page_history.length>0?_0x40c77a.duration/_0x40c77a.page_history.length:0,_0x1dfd90=_0xbef8f.scroll_depth_percentages&&_0xbef8f.scroll_depth_percentages.length>0?Math.max(..._0xbef8f.scroll_depth_percentages.map(_0x1bcd0f=>_0x1bcd0f.depth||0)):0,_0x2bc09f=_0xbef8f.time_between_clicks&&_0xbef8f.time_between_clicks.length>0?_0xbef8f.time_between_clicks.length/(_0x40c77a.duration/6e4):0;_0x40c77a.ml_features={session_duration:_0x40c77a.duration,avg_time_per_page:_0x4bce88,time_to_first_interaction:_0xbef8f.time_to_first_interaction||0,total_interactions:_0xbef8f.total_interactions||0,scroll_depth:_0x1dfd90,scroll_count:_0x40c77a.scroll_chunks?.length||0,click_count:_0x40c77a.cta_clicks?.length||0,clicks_per_minute:_0x2bc09f,form_interactions:_0x40c77a.form_interactions?.length||0,has_conversion:_0x40c77a.metrika_goals?.length>0,goals_count:_0x40c77a.metrika_goals?.length||0,device_type:_0x43f22c(),viewport_size:_0xbef8f.viewport_size||{width:_0x13b5e2.innerWidth,height:_0x13b5e2.innerHeight},path_depth:_0x13b5e2.location.pathname.split('/').filter(_0x4c2cc8=>_0x4c2cc8.length>0).length},_0x257a1e.debug('ML features updated:',_0x40c77a.ml_features)}catch(_0x3c0b59){_0x257a1e.error('Error updating ML features:',_0x3c0b59)}else _0x257a1e.warn('Cannot update ML features: no session data available')}

function _0x43f22c(){const _0x3fea90=navigator.userAgent;return/(tablet|ipad|playbook|silk)|(android(?!.*mobi))/i.test(_0x3fea90)?'tablet':/Mobile|Android|iP(hone|od)|IEMobile|BlackBerry|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/.test(_0x3fea90)?'mobile':'desktop'}
...
(function(){
    // Basic protection against direct function decompilation
    const _0x47e4c2 = function() {
        return false; // Disable aggressive console blocking
    };
    
    // Simple protection against obvious debugging
    const _0x30d67b = function() {
        return; // Disable aggressive anti-debugging
    };
    
    // Keep SDK internals clean but don't block anything
    if (_0x47e4c2()) {
        // Disabled aggressive console blocking
    }
    
    // Light check for debugging attempts
    const checkDebugger = () => {
    ...
    // Minimal protection interval
    setInterval(() => {
        checkDebugger();
    }, 5000);
})();

_0x13b5e2.RIVOX={init:_0x3dda1e,sendSessionSummary:_0x36c60e,getSessionData:()=>_0x40c77a,config:_0x3c8f0c,sendDataGuaranteed:_0x21d84a,startNewSession:_0x5d2ab9,get clientId(){return _0x40c77a?_0x40c77a.client_id instanceof Promise?'pending':_0x18a6f4(_0x40c77a.client_id):null},get sessionId(){return _0x40c77a?_0x40c77a.session_id:null},get isSessionActive(){return _0x3db7da}};

function _0x2b6ff8(_0x3d51a6=0,_0x414fb8=20){_0x3d51a6>=_0x414fb8?_0x257a1e.error('Failed to detect Yandex.Metrika after',_0x414fb8,'attempts'):'undefined'!=typeof ym||'undefined'!=typeof Ya||_0x13b5e2.yaCounter?_0x3dda1e().catch(_0x33be6b=>{_0x257a1e.error('Failed to initialize RIVOX SDK:',_0x33be6b)}):setTimeout(()=>_0x2b6ff8(_0x3d51a6+1),500)}

_0x2b6ff8();
document.addEventListener('DOMContentLoaded',function(){setTimeout(_0x13b5e2.RIVOX.init,_0x3c8f0c.initDelay)});
_0x257a1e.info('SDK loaded successfully');
})(window);
